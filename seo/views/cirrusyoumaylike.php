...
?>
 ...
 <h5>Thoughts You Might Like </h5> 


<div id="searchingthoughts" style="display:none;"><img src="images/loading.gif"/></div>

<div ng-if="cirrusYouMayLikeCtrl.thoughts.numPages > 1">
<nav>
  <ul class="pagination">
    <li>
      <a  aria-label="Previous" ng-click="cirrusYouMayLikeCtrl.getyoumaylikethoughtPageSpecial(cirrusYouMayLikeCtrl.pagControl(cirrusYouMayLikeCtrl.paginationpage-1))" 
      ng-if="cirrusYouMayLikeCtrl.paginationpage>1">
        <span aria-hidden="true" >&laquo;</span>
      </a>
    </li>
   
   
    <li ng-repeat="n in [cirrusYouMayLikeCtrl.thoughts.numPages] | makeRange" ng-class="cirrusYouMayLikeCtrl.activePag(n)" >
    
         <a ng-click="cirrusYouMayLikeCtrl.getyoumaylikethoughtPageSpecial(cirrusYouMayLikeCtrl.pagControl(n))" >{{n}}</a>
         
    </li>

    
    <li>
      <a aria-label="Next" ng-click="cirrusYouMayLikeCtrl.getyoumaylikehoughtPageSpecial(cirrusYouMayLikeCtrl.pagControl(cirrusYouMayLikeCtrl.paginationpage+1))"
      ng-if="cirrusYouMayLikeCtrl.paginationpage<cirrusYouMayLikeCtrl.thoughts.numPages ">        
 ...
 <div  style="margin:5px; float:right;">
		Order By:
		 ...
		 <button type="button" class="btn btn-default  btn-xs" ng-click="cirrusYouMayLikeCtrl.setThoughtOrderby(1)">
		  <span ng-class="cirrusYouMayLikeCtrl.getThoughtOrderClassDirection(1)" aria-hidden="true"></span> Date  <span ng-class="cirrusYouMayLikeCtrl.getThoughtOrderClassSelected(1)" aria-hidden="true"></span>
		</button>
		 
		 <button type="button" class="btn btn-default  btn-xs" ng-click="cirrusYouMayLikeCtrl.setThoughtOrderby(2)">
		     <span ng-class="cirrusYouMayLikeCtrl.getThoughtOrderClassDirection(2)" aria-hidden="true"></span> Cred  <span ng-class="cirrusYouMayLikeCtrl.getThoughtOrderClassSelected(2)" aria-hidden="true"></span></button>
		 </button>
 ...
 <div class="clr"></div>
  <!-- -------------------------------------------------------------------------------  -->
   <!-- -------------------------------------------------------------------------------  -->
    <!-- -------------------------------------------------------------------------------  -->
 <div ng-repeat="thought in cirrusYouMayLikeCtrl.thoughts.thoughtarray">
  ...
  <div ng-switch on="thought.file_type">
   ...
   <br />
    ...
    <div ng-switch-when="video">
                                   ...
                                   <button class="btn btn-lg btn-default" ng-if="cirrusYouMayLikeCtrl.videoplayer !== $index" ng-click = "cirrusYouMayLikeCtrl.setvideoplayer($index);">
                                  <span class="glyphicon glyphicon-play"></span> Video
                                  </span>
                                  </button>
  
				    <div style="width:100%; margin-left:auto; margin-right:auto; margin-top:25px; " ng-if="cirrusYouMayLikeCtrl.videoplayer === $index">
...
<div class="info" ng-if="cirrusYouMayLikeCtrl.thoughts.thoughtarray.length<1">
If you don&#39;t have your Interest set in your profile, select one, and more thoughts you might like will show up.
</div>
...
<nav>
  <ul class="pagination">
    ...
    <li>
      <a aria-label="Next" ng-click="cirrusYouMayLikeCtrl.getyoumaylikethoughtPageSpecial(cirrusYouMayLikeCtrl.pagControl(cirrusYouMayLikeCtrl.paginationpage+1))"
      ng-if="cirrusYouMayLikeCtrl.paginationpage<cirrusYouMayLikeCtrl.thoughts.numPages">        
      <span aria-hidden="true">&raquo;</span>
      </a>
    </li>
