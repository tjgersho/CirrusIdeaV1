...
<script>
 ...
 $CaptionSliderOptions: {                            //[Optional] Options which specifies how to animate caption
    ...
    <div style="position: relative; width: 100%; background-color: #CAFFCA; overflow: hidden;">
        <div style="position: relative; left: 50%; width: 5000px; text-align: center; margin-left: -2500px;">
            <!-- Jssor Slider Begin -->
            <div id="slider1_container" style="position: relative; margin: 0 auto;  top: 0px; left: 0px; width: 980px; height: 400px; background: url(images/bg.png) top center no-repeat;">
                <!-- Loading Screen -->
