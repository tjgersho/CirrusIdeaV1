<?php
require_once('modal/cirrusaddthought.php');
require_once('modal/cirrusdeletethought.php');
require_once('modal/cirrussharethought.php');
require_once('modal/cirrusreportthought.php');
	 ...
	 <a id="dLabel" data-target="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="float:right; display:block; width:25px; height:35px;">
				  ...
				  <ul class="dropdown-menu dropdown-menu-right"  aria-labelledby="dLabel" >
				    ...
				    <li style="text-align:center; padding:5px;">
				       <button class="btn btn-default btn-xs" ng-click="thoughtCtrl.shareThoughtDialogbtn(thought.id, $index)">
 ...
 <div style="padding:5px;">
  ...
  <div ng-switch on="thought.file_type">
    ...
    <div ng-switch-when="image" style="background-image: url('images/loading.gif'); background-repeat:no-repeat; background-position: center center;">
      ...
      <a ng-click="thoughtCtrl.downloadThoughtFile(thought.path)" rel="prettyPhoto"><img ng-src="{{thought.thumbnail}}" width="100%"/></a>
    </div>
